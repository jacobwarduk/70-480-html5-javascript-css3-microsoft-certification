<%@ Page Title="Change Password" Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ChangePassword.aspx.vb" Inherits="HelloVisualStudioForWeb.ChangePassword" %>
